...
const saveAsGoal = async () => {
  ...
  try {
    ...
    Swal.fire({
      title: 'Cel zapisany!',
      text: 'Twój cel oszczędnościowy został dodany pomyślnie.',
      icon: 'success',
      timer: 1500,
      showConfirmButton: false,
    })
  } catch (e) {
    console.error('Błąd podczas dodawania celu oszczędności:', e)
    alert('Wystąpił błąd podczas dodawania celu oszczędności. Spróbuj ponownie.')
  }
}
</script>
<template>
      ...
      <CardContent class="p-6">
        ...
        <div class="grid md:grid-cols-2 gap-10 mt-6">
          ...
          >
            ...
            >
              Dodaj jako nowy cel oszczędnościowy
            </Button>
          </div>
        </div>
      </CardContent>
